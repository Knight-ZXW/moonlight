...
//        Online online = getOnline(checkClient.getData()[0], authInfo);
        Online online = getOnline("1", authInfo);
    ...
    protected R<String[]> checkClient() {
        String basicHeader = ServletUtil.getHeader(WebUtils.request(),
                BASIC_HEADER_KEY, StrPool.UTF_8);
