 ...
 * 8，export 导出，并支持子类扩展3个方法：handlerPageParams、query、handlerResult
 * 9，preview 导出预览，并支持子类扩展3个方法：handlerPageParams、query、handlerResult
 * <p>
 * 其中 page、export、preview 的查询条件一致，若子类重写了 handlerPageParams、query、handlerResult 等任意方法，均衡受到影响
 * <p>
